    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative gradient-hero overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-20 -left-32 w-64 h-64 bg-primary/20 rounded-full blur-3xl" />
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
          ...
          >
            ...
            <p className="text-lg text-gray-300 mb-8 max-w-md">
              Sign in to continue analyzing your workflows and discovering new automation opportunities.
            </p>
